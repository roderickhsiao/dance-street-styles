...
export const PEOPLE: Record<string, PersonEntity> = {
  'don-campbell': {
    ...
    crewIds: ['the-lockers'],
    imageUrl: '/images/people/don-campbell.jpg',
  ...
  'fred-berry': {
    ...
    crewIds: ['the-lockers'],
    imageUrl: '/images/people/fred-berry.jpg',
  ...
  'lonny-carbajal': {
    ...
    imageUrl: '/images/people/lonny-carbajal.jpg',
  },
  'viktor-manoel': {
    id: 'viktor-manoel',
  ...
  'tyrone-proctor': {
    ...
    imageUrl: '/images/people/tyrone-proctor.jpg',
  },
  'jeffrey-daniel': {
    id: 'jeffrey-daniel',
  ...
  'willi-ninja': {
    ...
    crewIds: ['breed-of-motion'],
    imageUrl: '/images/people/willi-ninja.jpg',
